...
import FullImage from "./Img (1).webp";
import LeftImg from "./Img (11).webp";
import RightImg from "./Img (3).webp";
      ...
      <div className={styles.heroSection}>
        ...
        <AnimatedSection>
          <div className={styles.textSection}>
            <div className={styles.leftText}>BHOSALE GALAXY</div>
      ...
      <div className={styles.AboutSection}>
        ...
        <div className={styles.rightSide}>
          <p className={styles.headText}>
            <Link to="/projects">Projects</Link> - BHOSALE GALAXY
          </p>
          <p className={styles.aboutText}>
            This project is a <strong>residential development</strong> focused
            on <strong>modern living and efficient planning</strong>.
            <br />
            The design ensures{" "}
            <strong>functional layouts, good ventilation, and comfort</strong>.
            <br />
            It contributes to a{" "}
            <strong>well-planned residential experience</strong>.
          </p>
