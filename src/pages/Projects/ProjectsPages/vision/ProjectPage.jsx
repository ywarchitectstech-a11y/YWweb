      ...
      <div className={styles.heroSection}>
        ...
        <AnimatedSection>
          <div className={styles.textSection}>
            <div className={styles.leftText}>VISION</div>
      ...
      <div className={styles.AboutSection}>
        ...
        <div className={styles.rightSide}>
          <p className={styles.headText}>
            <Link to="/projects">Projects</Link> - VISION
          </p>
          <p className={styles.aboutText}>
            This project is a <strong>conceptual commercial development</strong>{" "}
            designed to explore future urban possibilities.
            <br />
            The vision emphasizes{" "}
            <strong>
              modern architectural expression and functional planning
            </strong>
            .
            <br />
            The design focuses on{" "}
            <strong>clarity, efficiency, and strong identity</strong>.
            <br />
            It represents a{" "}
            <strong>
              forward-thinking approach to commercial architecture
            </strong>
            .
          </p>
