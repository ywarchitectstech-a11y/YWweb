      ...
      <div className={styles.heroSection}>
        ...
        <AnimatedSection>
          <div className={styles.textSection}>
            <div className={styles.leftText}>TANISH INDRAYANI</div>
      ...
      <div className={styles.AboutSection}>
        ...
        <div className={styles.rightSide}>
          <p className={styles.headText}>
            <Link to="/projects">Projects</Link> - TANISH INDRAYANI
          </p>
          <p className={styles.aboutText}>
            This project, located in <strong>Charholi, Pune</strong>, was
            conceived as a{" "}
            <strong>community-oriented residential development</strong>.
            <br />
            The core vision emphasizes{" "}
            <strong>simplicity, functionality, and modern living</strong>.
            <br />
            The design explores{" "}
            <strong>linear massing and rhythmic façade articulation</strong>.
            <br />
            Repetitive elements and recessed balconies enhance{" "}
            <strong>thermal performance and visual depth</strong>.
            <br />
            The project promotes{" "}
            <strong>efficient planning and strong community interaction</strong>
            .
          </p>
          <div className={styles.stats}>
            ...
            <div className={`${styles.row} ${styles.three}`}>
              <div className={styles.col}>
                <p>Size</p>
                <h4>
                  Plot area : 9000.00 sq.m <br />
                  Built-up area : 28,447.33 sq.m <br />
                  High rise towers : 13 floors
                </h4>
              </div>

              <div className={styles.col}>
                <p>Client</p>
                <h4>TANISH INDRAYANI ASSOCIATES</h4>
              </div>
