      ...
      <div className={styles.heroSection}>
        ...
        <AnimatedSection>
          <div className={styles.textSection}>
            <div className={styles.leftText}>ALANDI SCHOOL</div>
      ...
      <div className={styles.AboutSection}>
        ...
        <div className={styles.rightSide}>
          <p className={styles.headText}>
            <Link to="/projects">Projects</Link> - ALANDI SCHOOL
          </p>
          <p className={styles.aboutText}>
            This project, located in <strong>Sangamner</strong>, was conceived
            as a <strong>modern educational campus</strong>.
            <br />
            The core vision was to create a{" "}
            <strong>
              safe, inspiring, and functional learning environment
            </strong>
            .
            <br />
            The design explores{" "}
            <strong>
              linear composition, vertical fins, shaded corridors, and
            ...
            The layout ensures{" "}
            <strong>
              efficient circulation, well-ventilated classrooms, and clear
              zoning
            </strong>
            .
            <br />
            ...
            <strong>
              learning experience through thoughtful spatial planning
            </strong>
            .
          </p>
