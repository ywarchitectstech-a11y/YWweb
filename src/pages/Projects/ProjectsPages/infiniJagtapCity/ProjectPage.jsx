      ...
      <div className={styles.heroSection}>
        ...
        <AnimatedSection>
          <div className={styles.textSection}>
            <div className={styles.leftText}>INFINI JAGTAP CITY</div>
      ...
      <div className={styles.AboutSection}>
        ...
        <div className={styles.rightSide}>
          <p className={styles.headText}>
            <Link to="/projects">Projects</Link> - INFINI JAGTAP CITY
          </p>
          <p className={styles.aboutText}>
            This project, located in <strong>Wadmukhwadi, Pune</strong>, was
            conceived as a{" "}
            <strong>
              large-scale residential development with integrated commercial
              frontage
            </strong>
            .
            <br />
            ...
            <strong>
              modern simplicity, openness, and community-centric living
            </strong>
            , while responding thoughtfully to its urban surroundings.
            <br />
            The design explores{" "}
            <strong>rhythm and repetition in vertical geometry</strong>,
            emphasizing balanced proportions, natural light optimization, and
            expansive views.
            <br />
            The façade articulation, defined by{" "}
            <strong>continuous balconies and vertical elements</strong>,
            enhances identity while maintaining efficiency.
            <br />
            Landscaped greens and defined frontage create a{" "}
            <strong>
              seamless transition between built form and public realm
            </strong>
            .
          </p>
